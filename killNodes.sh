...
lsof -n -i:8000 | grep LISTEN | awk '{ print $2 }' | xargs kill
...
lsof -n -i:8006 | grep LISTEN | awk '{ print $2 }' | xargs kill
lsof -n -i:8007 | grep LISTEN | awk '{ print $2 }' | xargs kill
lsof -n -i:8008 | grep LISTEN | awk '{ print $2 }' | xargs kill
lsof -n -i:8009 | grep LISTEN | awk '{ print $2 }' | xargs kill
...
lsof -n -i:8015 | grep LISTEN | awk '{ print $2 }' | xargs kill
lsof -n -i:8016 | grep LISTEN | awk '{ print $2 }' | xargs kill
lsof -n -i:8017 | grep LISTEN | awk '{ print $2 }' | xargs kill
lsof -n -i:8018 | grep LISTEN | awk '{ print $2 }' | xargs kill
lsof -n -i:8019 | grep LISTEN | awk '{ print $2 }' | xargs kill
...
lsof -n -i:26668 | grep LISTEN | awk '{ print $2 }' | xargs kill
lsof -n -i:26670 | grep LISTEN | awk '{ print $2 }' | xargs kill
lsof -n -i:26672 | grep LISTEN | awk '{ print $2 }' | xargs kill
lsof -n -i:26674 | grep LISTEN | awk '{ print $2 }' | xargs kill
lsof -n -i:26676 | grep LISTEN | awk '{ print $2 }' | xargs kill
